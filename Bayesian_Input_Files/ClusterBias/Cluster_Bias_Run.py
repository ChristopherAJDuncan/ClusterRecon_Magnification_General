...
Output_Paths = ['/disk1/cajd/Size_Magnification/Bayesian_DM_Profile_Constraints_Output/SizeMag/COMBO/', \
                '/disk1/cajd/Size_Magnification/Bayesian_DM_Profile_Constraints_Output/SizeMag/STAGES/', \
                '/disk1/cajd/Size_Magnification/Bayesian_DM_Profile_Constraints_Output/SizeOnly/COMBO/', \
                '/disk1/cajd/Size_Magnification/Bayesian_DM_Profile_Constraints_Output/SizeOnly/STAGES/']

Ini_Pathway = CWD+'/'

Ini_Files = ['Mock_COMBO_ClusterBias_SizeMag.ini', \
             'Mock_STAGES_ClusterBias_SizeMag.ini', \
             'Mock_COMBO_ClusterBias_SizeOnly.ini', \
             'Mock_STAGES_ClusterBias_SizeOnly.ini' ]
...
#    set_OutputDirectory_IniFile(Output_Paths[i], Ini_Pathway+Ini_Files[i])
    ...
    os.system(Program_Name+' '+Ini_Pathway+Ini_Files[i]+ ' > '+Output_Paths[i]+'ClusterBiasLog &')

    print Program_Name+' '+Ini_Pathway+Ini_Files[i]+ ' > '+Output_Paths[i]+ 'ClusterBiasLog &'
    print ' '
