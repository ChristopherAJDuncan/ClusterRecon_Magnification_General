...
for c in range(0, len(Mass_Directories)):
    ...
    if(c==1):
        ax.errorbar(Input_Mass, Bias_Input[Mass_Bias_Col]/(Input_Mass), yerr = [[Bias_Input[Mass_Error_Cols[1]]/(Input_Mass)],[Bias_Input[Mass_Error_Cols[0]]/(Input_Mass)]], color = Experiment_Colour[0], linewidth = 3., marker = 'x')
#        ax.errorbar(Bias_Input[Recovered_Mass_Col], Bias_Input[Mass_Bias_Col], yerr = (Bias_Input[Mass_Error_Cols[0]], Bias_Input[Mass_Error_Cols[1]]), color = Experiment_Colour[0], linewidth = 3., marker = 'x', label = 'Lensed Prior')
        ...
        ax.errorbar(Input_Mass, Bias_Input[Mass_Bias_Col]/(Input_Mass), yerr = [[Bias_Input[Mass_Error_Cols[1]]/(Input_Mass)],[Bias_Input[Mass_Error_Cols[0]]/(Input_Mass)]], color = Experiment_Colour[0], linewidth = 3., marker = 'x')
#        ax.errorbar(Input_Mass, Bias_Input[Mass_Bias_Col], yerr = [[Bias_Input[Mass_Error_Cols[1]]],[Bias_Input[Mass_Error_Cols[0]]]], color = Experiment_Colour[0], linewidth = 3., marker = 'x')
