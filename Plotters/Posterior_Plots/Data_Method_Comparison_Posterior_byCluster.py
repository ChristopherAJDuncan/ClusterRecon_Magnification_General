...
Dir_Head = '/disk1/cajd/Size_Magnification/Bayesian_DM_Profile_Constraints_Output/MagCutsTesting_Data/SingleClusterFit/4Cluster/RRG+STAGES/SM+M/'
...
Aperture_Label = [' ','A901a', 'A901b', 'A902', 'SWa'] #Always leave first empty, or discardable
Colours = ['k', 'b', 'r', 'c']
Marker = ['o','x','v', 's']
