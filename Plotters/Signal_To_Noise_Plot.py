...
for Clus in range(0, len(Control_Experiment_Directory)):
    ...
    ##Plot Control:
    print 'Getting Control StN:', Bias_Directory_Head+Control_Experiment_Directory[Clus]+Mass_Directory[Clus]+Run_Directory[Clus]
    ...
    print 'Getting CC StN:', Bias_Directory_Head+CC_Experiment_Directory[Clus]+Mass_Directory[Clus]+Run_Directory[Clus]
